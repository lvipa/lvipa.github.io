---
layout: default
title: Ivan Lipatov — DevOps Engineer
lang: en
permalink: /en/
translation: /
---
...
<section class="hero shell">
  <div class="hero-copy">
    ...
    <h1 class="hero-manifesto">
      ...
      <span class="hero-word hero-word--medium">Versioning.</span>
      <span class="hero-word hero-word--small">Automation.</span>
      <span class="hero-word hero-word--xsmall">Networking.</span>
    </h1>
    ...
    <div class="hero-actions">
      ...
      <a class="button button-secondary" href="https://kinel.hh.ru/resume/db09e170ff040672c60039ed1f45784f6b6959">View resume</a>
    </div>
    <div class="profile-links" aria-label="Professional profiles">
      ...
      <a href="{{ '/en/contact/' | relative_url }}">All contacts →</a>
    </div>
  </div>
  <div class="hero-photo-wrap">
    <img class="hero-photo" src="{{ '/assets/images/ivan-lipatov.jpeg' | relative_url }}" alt="Ivan Lipatov">
  </div>
</section>
...
<section class="home-nav">
  <div class="shell">
    ...
    <div class="nav-grid">
      ...
      <a class="nav-card" href="{{ '/en/contact/' | relative_url }}"><strong>Contact</strong><span>LinkedIn, Telegram, GitHub and résumé.</span></a>
    </div>
  </div>
</section>
